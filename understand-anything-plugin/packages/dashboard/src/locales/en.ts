export const en = {
  ...
  why: {
    ...
    subtitle: "{count} decision discovered",
    subtitle_other: "{count} decisions discovered",
    noDecisions: "No decisions discovered yet — run /understand-decisions",
    whyThisCode: "Why this code?",
    whyThisCodeWithCount: "Why this code? ({count})",
    noDecisionsForNode: "No decisions reference this node yet.",
    searchPlaceholder: "Search decisions…",
    tradeoffMatrix: "Tradeoff matrix",
    decisionTree: "Decision tree",
    onlyNodesWithDecisions: "Only nodes with decisions",
    decisionsLoaded: "{count} decision loaded",
    decisionsLoaded_other: "{count} decisions loaded",
    noDecisionsLoaded: "No decisions loaded yet",
    errorLoading: "Error: {message}",
    loading: "Loading…",
  },
  uiLearn: {
    title: "UI Learn",
    subtitle: "Click any feature to inspect its CRUD flow and full call chain",
    featureList: "Feature points",
    noFeatures: "No feature points discovered yet",
    noFeaturesHint: "Re-run /understand with explicit feature annotations to populate this list",
    featureCount_one: "1 feature",
    featureCount_other: "{count} features",
    searchPlaceholder: "Search features…",
    openFeature: "Open feature",
    backToList: "← Back to feature list",
    crudTitle: "CRUD breakdown",
    crud: {
      create: "Create",
      read: "Read",
      update: "Update",
