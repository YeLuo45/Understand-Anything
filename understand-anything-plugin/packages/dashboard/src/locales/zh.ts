export const zh = {
  ...
  personaSelector: {
    ...
    uiLearn: "UI 学习",
    uiLearnDesc: "交互式功能点浏览器",
    architect: "架构师",
    architectDesc: "Why 模式: 查看决策、权衡、ADR 原理",
  },
  why: {
    title: "Why / 架构决策",
    subtitle: "发现 {count} 个决策",
    subtitle_other: "发现 {count} 个决策",
    noDecisions: "暂未发现决策 — 运行 /understand-decisions",
    whyThisCode: "为什么这样写?",
    whyThisCodeWithCount: "为什么这样写? ({count})",
    noDecisionsForNode: "暂无决策引用此节点。",
    searchPlaceholder: "搜索决策…",
    tradeoffMatrix: "权衡矩阵",
    decisionTree: "决策树",
    onlyNodesWithDecisions: "仅显示有决策的节点",
    decisionsLoaded: "已加载 {count} 个决策",
    decisionsLoaded_other: "已加载 {count} 个决策",
    noDecisionsLoaded: "暂无决策数据",
    errorLoading: "错误: {message}",
    loading: "加载中…",
  },
  uiLearn: {
    title: "UI 学习",
    subtitle: "点击任意功能点查看其增删改查流程和完整调用链",
    featureList: "功能点",
    noFeatures: "暂未发现功能点",
    noFeaturesHint: "重新运行 /understand 并显式标注 feature 以填充此列表",
    featureCount_one: "1 个功能点",
    featureCount_other: "{count} 个功能点",
    searchPlaceholder: "搜索功能点…",
    openFeature: "打开功能点",
    backToList: "← 返回功能点列表",
    crudTitle: "增删改查分解",
    crud: {
