export const zhTW = {
  ...
  why: {
    title: "Why / 架構決策",
    subtitle: "發現 {count} 個決策",
    subtitle_other: "發現 {count} 個決策",
    noDecisions: "暫未發現決策 — 執行 /understand-decisions",
    whyThisCode: "為什麼這樣寫?",
    whyThisCodeWithCount: "為什麼這樣寫? ({count})",
    noDecisionsForNode: "暫無決策引用此節點。",
    searchPlaceholder: "搜尋決策…",
    tradeoffMatrix: "權衡矩陣",
    decisionTree: "決策樹",
    onlyNodesWithDecisions: "僅顯示有決策的節點",
    decisionsLoaded: "已載入 {count} 個決策",
    decisionsLoaded_other: "已載入 {count} 個決策",
    noDecisionsLoaded: "暫無決策資料",
    errorLoading: "錯誤: {message}",
    loading: "載入中…",
  },
  uiLearn: {
    title: "UI 學習",
    subtitle: "點擊任意功能點查看其 CRUD 流程和完整呼叫鏈",
    featureList: "功能點",
    noFeatures: "暫未發現功能點",
    noFeaturesHint: "重新執行 /understand 並顯式標註 feature 以填充此列表",
    featureCount_one: "1 個功能點",
    featureCount_other: "{count} 個功能點",
    searchPlaceholder: "搜尋功能點…",
    openFeature: "開啟功能點",
    backToList: "← 返回功能點列表",
    crudTitle: "CRUD 分解",
    crud: {
