export const ja = {
  ...
  why: {
    title: "Why / アーキテクチャ決定",
    subtitle: "{count} 件の決定",
    subtitle_other: "{count} 件の決定",
    noDecisions: "決定がまだありません — /understand-decisions を実行",
    whyThisCode: "なぜこのコード?",
    whyThisCodeWithCount: "なぜこのコード? ({count})",
    noDecisionsForNode: "このノードを参照する決定はありません。",
    searchPlaceholder: "決定を検索…",
    tradeoffMatrix: "トレードオフ表",
    decisionTree: "決定ツリー",
    onlyNodesWithDecisions: "決定のあるノードのみ",
    decisionsLoaded: "{count} 件の決定を読み込み済み",
    decisionsLoaded_other: "{count} 件の決定を読み込み済み",
    noDecisionsLoaded: "決定データなし",
    errorLoading: "エラー: {message}",
    loading: "読み込み中…",
  },
  uiLearn: {
    title: "UI 学習",
    subtitle: "機能ポイントをクリックして CRUD フローと完全な呼び出しチェーンを確認",
    featureList: "機能ポイント",
    noFeatures: "機能ポイントが見つかりません",
    noFeaturesHint: "/understand を再実行し、機能アノテーションを明示的に追加してください",
    featureCount_one: "1 件の機能",
    featureCount_other: "{count} 件の機能",
