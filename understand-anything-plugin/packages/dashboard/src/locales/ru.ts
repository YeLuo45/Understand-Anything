export const ru = {
  ...
  why: {
    title: "Why / Архитектурные решения",
    subtitle: "Найдено {count} решение",
    subtitle_other: "Найдено {count} решений",
    noDecisions: "Решений пока нет — выполните /understand-decisions",
    whyThisCode: "Почему этот код?",
    whyThisCodeWithCount: "Почему этот код? ({count})",
    noDecisionsForNode: "Нет решений, ссылающихся на этот узел.",
    searchPlaceholder: "Поиск решений…",
    tradeoffMatrix: "Матрица компромиссов",
    decisionTree: "Дерево решений",
    onlyNodesWithDecisions: "Только узлы с решениями",
    decisionsLoaded: "Загружено {count} решение",
    decisionsLoaded_other: "Загружено {count} решений",
    noDecisionsLoaded: "Решения не загружены",
    errorLoading: "Ошибка: {message}",
    loading: "Загрузка…",
  },
  uiLearn: {
    title: "UI Обучение",
    subtitle: "Нажмите на функцию, чтобы увидеть её CRUD-разбивку и полную цепочку вызовов",
    featureList: "Функции",
    noFeatures: "Функции не найдены",
    noFeaturesHint: "Перезапустите /understand с явными аннотациями функций",
    featureCount_one: "1 функция",
    featureCount_other: "{count} функций",
    searchPlaceholder: "Поиск функций…",
    openFeature: "Открыть функцию",
    backToList: "← Назад к списку функций",
    crudTitle: "CRUD-разбивка",
    crud: {
      create: "Создание",
      read: "Чтение",
      update: "Обновление",
    ...
    openCode: "Показать код",
    closeCode: "Закрыть код",
    codePanelTitle: "Код",
    loading: "Загрузка…",
    strategy: "Стратегия",
