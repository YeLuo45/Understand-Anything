export const ko = {
  ...
  why: {
    title: "Why / 아키텍처 결정",
    subtitle: "{count}개 결정 발견",
    subtitle_other: "{count}개 결정 발견",
    noDecisions: "결정이 없습니다 — /understand-decisions 실행",
    whyThisCode: "왜 이 코드?",
    whyThisCodeWithCount: "왜 이 코드? ({count})",
    noDecisionsForNode: "이 노드를 참조하는 결정이 없습니다.",
    searchPlaceholder: "결정 검색…",
    tradeoffMatrix: "트레이드오프 매트릭스",
    decisionTree: "결정 트리",
    onlyNodesWithDecisions: "결정이 있는 노드만",
    decisionsLoaded: "{count}개 결정 로드됨",
    decisionsLoaded_other: "{count}개 결정 로드됨",
    noDecisionsLoaded: "로드된 결정 없음",
    errorLoading: "오류: {message}",
    loading: "로드 중…",
  },
  uiLearn: {
    title: "UI 학습",
    subtitle: "기능 포인트를 클릭하여 CRUD 흐름과 전체 호출 체인 확인",
    featureList: "기능 포인트",
    noFeatures: "기능 포인트가 발견되지 않았습니다",
    noFeaturesHint: "기능 주석을 명시하여 /understand 를 다시 실행하세요",
    featureCount_one: "1개 기능",
    featureCount_other: "{count}개 기능",
    searchPlaceholder: "기능 검색…",
    openFeature: "기능 열기",
    backToList: "← 기능 목록으로 돌아가기",
    crudTitle: "CRUD 분석",
    crud: {
      create: "생성",
      read: "읽기",
